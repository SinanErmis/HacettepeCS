...
const int MAX_SIZE = 81;  // Define maximum number of provinces considering the problem at hand

class Map {
public:

    int **distanceMatrix;      // Define 2D distance matrix between provinces
